            ...
            steps {
                script {
                    try {
			            ...
			            emailext body: ' ${JOB_NAME} ${BUILD_NUMBER} a échoué! Quelqu'un devrait faire quelque chose à ce sujet.https://jenkins.dev.inspq.qc.ca/job/utilitaire-nam/job/utilitaire-nam-construction/${BUILD_NUMBER}/console', subject: 'FAILURE', to: "${NOTIFICATION_TEAM}"
