...
Numéro d'assurance maladie à valider

province

Province qui a émis le numéro d'assurance maladie:
...
Le NAM n'est pas valide

400 bad request

Message d'erreur lorsque les paramètres ne sont pas valides.
...
Nom de famille de l'usager pour lequel générer le NAM
...
Code de sexe de l'usager

datenaissance

Date de naissance de l'usager en format AAAA-MM-JJ

province

Code de province du NAM à générer
...
Numéro d'assurance maladie pour lequel obtenir les infromations
...
Sexe de l'usager. Les valeurs possible sont MASCULIN ou FEMININ
...
![](attachments/1071481676/1071515048.png)

### Générer un NAM

![](attachments/1071481676/1071482130.png)

### Information sur un NAM

![](attachments/1071481676/1071515053.png)
