...
import ca.qc.inspq.nam.api.domaine.modele.CaractereValidateur;
...
public class ServiceUtilitairesNAM {
    ...
    private LocalDate trouverDateNaissance(String nam) throws UnsupportedEncodingException, ParseException {
