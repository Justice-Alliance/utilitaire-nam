            ...
            steps {
                script {
				    ...
				    sh 'git commit -m "Mise à jour dépendances maven" && git push || echo "Aucune dependances mise a jour"'
			            ...
			            emailext body: ' ${JOB_NAME} ${BUILD_NUMBER} a échoué! Vous devez faire quelque chose à ce https://jenkins.dev.inspq.qc.ca/job/utilitaire-nam/job/utilitaire-nam-construction-nuit/${BUILD_NUMBER}/console', subject: 'FAILURE', to: "${NOTIFICATION_TEAM}"
			        }
