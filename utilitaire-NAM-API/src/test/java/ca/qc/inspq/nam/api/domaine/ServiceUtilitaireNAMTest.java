package ca.qc.inspq.nam.api.domaine;
...
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieAlbertaValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieColombieBritanniqueValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieIleDuPrinceEdouardValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieManitobaValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieNouveauBrunswickValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieNouvelleEcosseValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieNunavutValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieOntarioValideSpecification;
import ca.qc.inspq.nam.api.domaine.specifications.NumeroAssuranceMaladieQuebecValideSpecification;
...
public class ServiceUtilitaireNAMTest {
	...
	@Test
	public void quandJeDemandeDobtenirLesInformationsContenuesDansUnNam_alorsLeNamEstValiderAvecLaSpecificationDeValiditeDeNamDuQuebec () 
	...
	public void quandJeDemandeDobtenirLesInformationsContenuesDansUnNAM_siLeNamEstUnNamDeFemme_alorsJeRetourneFeminin()
		...
		assertThat(informationsObtenues.getSexe()).isEqualTo(Sexe.FEMININ);
	}
	
	@Test
	public void quandJeDemandeDobtenirLesInformationsContenuesDansUnNAM_siLeNamEstUnNamDhomme_alorsJeRetourneMasculin()
			throws UnsupportedEncodingException, ParseException {
		when(numeroAssuranceMaladieQuebecValideSpecification.estSatisfaitePar(eq(NAM_QUEBEC))).thenReturn(true);
	...
	@Test
	public void quandJeDemandDobtenirLesInformationsContenuesDansUnNAM_siLeNamEstValide_alorsJeRetourneLaDateDeNaissance()
			throws UnsupportedEncodingException, ParseException{
		when(numeroAssuranceMaladieQuebecValideSpecification.estSatisfaitePar(eq(NAM_QUEBEC))).thenReturn(true);
		var informationsObtenues = serviceUtilitaireNAM.obtenirInformationsContenuesDansLeNam(NAM_QUEBEC);
		assertThat(informationsObtenues.getDateNaissance()).isEqualTo(DATE_NAISSANCE);
	}
	
	@Test
	public void quandJeDemandeDobtenirLesInformationsContenuesDansUnNAMDunePersonneDeplusDeCentAns_siLeNamEstValide_alorsJeRetourneLaDateDeNaissance()
			throws UnsupportedEncodingException, ParseException {
		...
		assertThat(informationsObtenues.getDateNaissance()).isEqualTo(DATE_NAISSANCE_PLUS_DE_CENT_ANS);
	}
}